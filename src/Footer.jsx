      ...
      <Row className="px-1">
        <div className="social d-flex gap-3">
          ...
          <svg
            ...
            height="24px"
            fill="#808080"
            className="bi bi-twitter social-icon"
            viewBox="0 0 16 16"
          >
          ...
          <svg
            ...
            height="24px"
            fill="#808080"
            className="bi bi-youtube social-icon"
            viewBox="0 0 16 16"
          >
        ...
        <Col xs={3} className="mt-3">
          <ul className="d-flex flex-column p-0 gap-2">
            <a
              href="#home"
              className="link-opacity-75 link-secondary link-underline-opacity-0 small"
            >
              Audio and Subtitles
            </a>
            <a
        ...
        <div className="button-service-code mt-3">
          <Button variant="outline-secondary" className="rounded-0">
            Service Code
          </Button>
          <p className="link-secondary pt-3 small">
